/*! paginator v0.7.2 ~ (c) 2012-2017 pzhang@ewaytec.cn ~ http://gitsrv01.ewaytec.cn/frontend-components-team/paginator.git */
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _pattern2 = __webpack_require__(6);
	...
	$.extend(position.prototype, {
	    ...
	    recover: function recover(scroll, options, callback) {
	        ...
	        if (this.tempSize && this.page.size != this.tempSize) {
	            (function () {
	                _this2.page.index = _this2.page.size / _this2.tempSize;
	                _this2.page.size = _this2.tempSize;
	                _this2.page.lastSize = _this2.page.size;
	                _this2.tempSize = null;
	...
	$.extend(_core2.default.prototype, {
	    ...
	    render: function render() {
	        ...
	        if (me.paginator.scroller && $(me.paginator.options.element.wrapper).hasClass('scrollerWrapper')) {
	            ...
	            // 如果没有开启定位，滚动到顶端
	            if (!me.paginator.pattern.position.enabled()) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	$.extend(_core2.default.prototype, {
	    ...
	    remote: function remote(callback) {
	        ...
	        me.options.data.pageNum = me.options.data.pageIndex;
	        ...
	        me.options.customAjax.get(me.options.url, me.options.data, null, {
	            ...
	            // 列表数据内容为空
	            if (!result[me.options.server.key]) {
	                callback(true, []);
	                return;
	            }
	            ...
	            me.options.page.count = Math.ceil(total / me.options.data.pageSize);

	            if (me.options.data.pageIndex * me.options.data.pageSize >= total) {
